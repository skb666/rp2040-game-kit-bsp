...
#ifndef PINDEFINITIONSANDMORE_H
#define PINDEFINITIONSANDMORE_H
/*
...
#define IR_SEND_PIN         24
#define TONE_PIN            23
#define APPLICATION_PIN     5
#define ALTERNATIVE_IR_FEEDBACK_LED_PIN 4 // E.g. used for examples which use LED_BUILDIN for example output.
#define _IR_TIMING_TEST_PIN  7
